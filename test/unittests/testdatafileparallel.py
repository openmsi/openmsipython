...
class TestUploadDataFile(unittest.TestCase) :
    ...
    def test_initial_properties(self) :
        ...
        self.assertEqual(self.datafile.upload_status_msg,f'{TEST_CONST.TEST_DATA_FILE_PATH.relative_to(self.datafile._rootdir)} (waiting to be enqueued)')
    ...
    def test_add_chunks_to_upload_queue(self) :
        ...
        self.assertEqual(self.datafile.upload_status_msg,f'{TEST_CONST.TEST_DATA_FILE_PATH.relative_to(self.datafile._rootdir)} (in progress)')
        self.assertFalse(self.datafile.fully_enqueued)
        ...
        self.assertFalse(self.datafile.waiting_to_upload)
        self.assertFalse(self.datafile.upload_in_progress)
        self.assertEqual(self.datafile.upload_status_msg,f'{TEST_CONST.TEST_DATA_FILE_PATH.relative_to(self.datafile._rootdir)} (fully enqueued)')
