...
-----------------------------------------
From Maggie
This code is copied directly from a blog post on "thepythoncorner" by the above-mentioned Davide Mastromatteo.
The post can be found here: http://thepythoncorner.com/dev/how-to-create-a-windows-service-in-python/
'''
