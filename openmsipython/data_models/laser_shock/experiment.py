...
from openmsipython.data_models.run_from_filemaker_record import (
    MeasurementRunFromFileMakerRecord,
)
...
class LaserShockExperimentSpec(SpecForRun):
    ...
    def get_spec_kwargs(self):
        ...
        spec_kwargs[
            "notes"
        ] = "A spec for performing a Laser Shock Experiment measurement"
        # conditions
    ...
    def __get_conditions(self):
        ...
        for name, val in namesvals:
            ...
            try:
                ...
                conditions.append(
                    Condition(
                        name=name.replace(" ", "") + "CouldNotCast",
...
class LaserShockExperiment(MeasurementRunFromFileMakerRecord):
    ...
    def __init__(self, record, launch_packages, **kwargs):
        ...
        self.launch_package = search_for_single_name(
            [lp for lp in launch_packages],
            self.launch_ID,
            logger=logger,
            raise_exception=(logger is None),
        )
